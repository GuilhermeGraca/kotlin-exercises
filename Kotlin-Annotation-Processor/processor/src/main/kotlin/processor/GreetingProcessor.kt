...
* 1. O processador faz scan de todos os metodos que tenham anotação @Greeting
* 2. Para cada class q tenha metodos anotados ele cria um wrapper correspondente
* 3. A class wrapper usa composição para guardar a referencia original da class
* 4. Para cada metodo anotado, ele gera um metodo wrapper para a class original que:
*   - Imprime a mensagem especificada na annotation
*   - Delega a chamada original para o metodo da class original, a passar os mesmos parametros
* 5. O codigo gerado é escrito na diretoria build com o uso do KotlinPoet
*
* */
